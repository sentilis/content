...
- An `index.md` file as the main star of your show.
- (Or, if you don't have an `index.md`, just one `.md` file inside will do the trick!)


*Ready to dive deeper? Learn how to tweak your settings in our [Formatter Guide](./press-formatter.md), or discover how to add cool attachments in our [Advanced Guide](./press-advanced.md).*
